...
(function() {
            ...
            var make_attempt = function() {
              C.web3.eth.getTransactionReceipt(tx, function(err, receipt) {
                ...
                if (timeout > 0 && new Date().getTime() - start > timeout) {
                  return reject(new Error("Transaction " + tx + " wasn't processed in " + (timeout / 1200) + " seconds!"));
                }

                setTimeout(make_attempt, 1200);
              });
            };
  ...
  "2": {
    ...
    "events": {},
    "updated_at": 1473288757560,
    "address": "0x13cedc9b746ece8031b5f4066eaf34adda5c104b",
    "links": {}
  },
  "default": {
    "abi": [
    ...
    "unlinked_binary": "",
    "events": {},
    "updated_at": 1473286321140,
    "address": "0xbeadef152c07e2352f9539e9261e96e7392c0952",
    "links": {}
  }
};
